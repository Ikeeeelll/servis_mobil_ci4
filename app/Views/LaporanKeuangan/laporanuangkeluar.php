...
<form action="<?= base_url('Laporanuangkeluar/filter') ?>" method="get" class="filter-bar bg-light p-3 rounded shadow-sm mb-4">
    ...
    <div class="row align-items-end g-3">
        ...
        <div class="col-md-2 d-flex justify-content-end gap-2">
            ...
            <a href="<?= base_url('Laporanuangkeluar/index') ?>" class="btn btn-secondary btn-sm shadow-sm" title="Reset Filter">
            ...
            <?php if (!empty($dataUangKeluar)): ?>
                ...
                foreach ($dataUangKeluar as $row): 
                    ...
                    <tr>
                        ...
                        <!-- <td class="text-center"><?= esc($row['id_ref']) ?></td> -->
                ...
                <td colspan="4" class="text-end"><strong>Total Uang Keluar</strong></td>
